...
export const getLabels = async (): Promise<GitHubLabel[]> => {
  ...
  try {
    const resp = await fetch(`http://api.github.com/repos/angular/angular/labels`);//resp es un objeto Response que luce asi:  Response {type: 'cors', url: 'https://api.github.com/repos/angular/angular/labels', redirected: true, status: 200, ok: true, …}
